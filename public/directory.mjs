...
import { ENDPOINT_SOCKET_IO, NAMESPACE_SOCKET_IO_DIRECTORY } from "./lib/endpoints.mjs";
...
async function onPost() {
    try {
        ...
        //     throw new Error('Error in fetching users from DB');
        // }
...
function displayUsers(users) {
    ...
    sortedUsers.forEach(user => {
        ...
        statusDot.style.backgroundColor = (user.status === 'online') ? 'green' : 'grey';
...
document.addEventListener('DOMContentLoaded', onPost);
$(document).ready(() => {
